...
class Mochila {
    ...
    inserirItems(items) {
        ...
        const melhor = Solucao.aprimorarSolucao(s, items, penalidade, this.capacidade)
...
class Solucao {
    ...
    static aprimorarSolucao(anterior, items, penalidade, b) {
        ...
        const atual = Solucao.ordenarFs(solucoes)[0]
        // Maximizou o resultado ?
        return atual.fs > anterior.fs 
